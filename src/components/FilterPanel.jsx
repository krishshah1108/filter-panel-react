...
const FilterPanel = () => {
  return (
    <div className='flex flex-col max-w-[300px] w-full gap-3 p-2 bg-[#ebe8e8] border border-gray-200 rounded-sm shadow-sm'>
      <div className='flex justify-between items-centerp-1'>
